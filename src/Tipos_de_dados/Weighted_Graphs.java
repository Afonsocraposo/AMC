...
public interface Weighted_Graphs {
	...
	Edge adj(int node, ArrayList<Integer> visited); //recebe o nó, node, e a lista de nós visitadoss, visited, e devolve a aresta com o maior peso que leva a um nó ainda não visitado
}
